...
ActiveAdmin.register Trade do
  ...
  index :download_links => false do
    ...
    column(:day)         { |trade| format_price_and_variation(*trade.day_performance) }
    ...
    column(:loss_max)    { |trade| format_price_and_variation(trade.max_loss, trade.max_loss_variation) }
  end
  ...
  show do |trade|
    attributes_table do
      ...
      row(:day)         { |trade| format_price_and_variation(*trade.day_performance, { :right_align => false }) }
      ...
      row(:loss_max)    { |trade| format_price_and_variation(trade.max_loss, trade.max_loss_variation, { :right_align => false }) }
    end
  end
